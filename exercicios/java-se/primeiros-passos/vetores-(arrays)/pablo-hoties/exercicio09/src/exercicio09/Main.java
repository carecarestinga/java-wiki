...
public class Main {
	...
	public static void main(String[] args) {
		...
		for (int p = 0; p < vetorB.length; p++) {
			System.out.print("Digite um número inteiro que estará no vetorB e no indíce " + p + " : ");
		...
		for (int p = 0; p < vetorC.length; p++) {
			...
			System.out.println("Exibindo um número inteiro que está no vetorC e no indíce " + p + " : " + vetorC[p]);
		}
	}
}
